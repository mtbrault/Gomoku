...
def clean():
	os.system("rm -f src/main.o src/board.o src/IA.o src/Game.o pbrain-test")
...
def compile():
	...
	os.system("g++ src/main.o src/Game.o src/board.o src/IA.o -o pbrain-test -I./include -Wall -Wextra -Werror -std=c++14")
